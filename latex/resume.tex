...
% \makeheading{Curriculum Vitae\\ [0.3cm] TIEP HUU VU\quad~~~~~~\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad{\small Last update: December 17, 2015}}
\makeheading{CHEN Han \hfill {\small Last update: Dec 18, 2023}}
...
Mentor: \href{https://zeyiwen.github.io/}{Zeyi WEN}\hfill Apr-Sept.  2023\\
\vspace{-0.2in}
\begin{innerlist}
        \item Research on the Graph Partitioning Algorithm and fillin-reducing ordering algorithm.
        \item Use omp task to optimize the graph partitioning algorithm.
\end{innerlist}

\item {\it\textbf{Student Intern}} in \textbf{Applied Crypto Team, SG Digital Trust Lab}\\
Mentor: Huang Tao \hfill Jan.-May.  2024(Expected)\\
\end{outerlist}
...
% \makeheading{Curriculum Vitae\\ [0.3cm] TIEP HUU VU\quad~~~~~~\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad{\small Last update: December 17, 2015}}
\makeheading{陈 涵 \hfill {\small 最近更新: 十二月 19, 2023}}
...
%\texttt{Gitee:}\href{https://www.gitee.com/Concyclics}{www.gitee.com/concyclics}\\
\texttt{Kaggle:}\href{https://www.kaggle.com/concyclics}{www.kaggle.com/concyclics} \\
\texttt{地址}: 新加坡West Coast Residental Village 09-01 127371\\												
\end{tabular}
\end{minipage}
\begin{minipage}[r]{0.5\textwidth}
\vspace{0.1in}
...
\vspace{-0.4in}
\\
\href{https://www.nus.edu.sg/}{\textbf{新加坡国立大学}}, 计算机科学硕士, 新加坡. \hfill 2023--2025(预计)
\\
