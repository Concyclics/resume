...
% \makeheading{Curriculum Vitae\\ [0.3cm] TIEP HUU VU\quad~~~~~~\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad{\small Last update: December 17, 2015}}
\makeheading{CHEN Han \hfill {\small Last update: August 21st, 2026}}
...
\texttt{Google Scholar:}\\
{\small\url{https://scholar.google.com/citations?user=ru1OE6wAAAAJ}}\\
...
\texttt{Address}: NUS School of Computing, Singapore 117417 \\
\end{tabular}
\end{minipage}
\hfill
...
\href{https://www.nus.edu.sg/}{\textbf{National University of Singapore}}, Singapore. \hfill 2025--now
        \begin{innerlist}
                \item Doctor of Philosophy, Computer Science. \hfill Supervisor: \href{https://www.comp.nus.edu.sg/~hebs/}{Prof.HE Bingsheng}
        \end{innerlist}
...
\vspace{-0.5in}
\begin{outerlist}
\item \textit{\textbf{CHEN Han}, Zining Zhang, Wenqi Pei, Bingsheng He, Ming Wu, Jason Zeng, Michael Heinrich, Wei Wu, Hongbao Zhang.} \href{https://arxiv.org/abs/2605.23986}{\textbf{MemForest: An Efficient Agent Memory System with Hierarchical Temporal Indexing}}. Revision for VLDB 2027 \hfill 2026
\item \textit{\textbf{CHEN Han}, Tao Huang, Phuong Pham, Shuang Wu.} \href{https://eprint.iacr.org/2025/377}{\textbf{HiAE: A High-Throughput Authenticated Encryption Algorithm for Cross-Platform Efficiency}}. Cryptology ePrint Archive, Report 2025/377 \hfill 2025
\item \textit{\textbf{CHEN Han}, Zicong Jiang, Zining Zhang, Bingsheng He, Pingyi Luo, Mian Lu, Yuqiang Chen.} \href{https://arxiv.org/abs/2503.19950}{\textbf{LogQuant: Log-Distributed 2-Bit Quantization of KV Cache with Superior Accuracy Preservation}}. Accepted at ICLR 2025 Workshop on Sparsity in LLMs \hfill 2025
\item \textit{Wenqi Pei, Hailing Xu, Henry Hengyuan Zhao, Shizheng Hou, \textbf{CHEN Han}, Zining Zhang, Pingyi Luo, Bingsheng He.} \href{https://aclanthology.org/2025.findings-ijcnlp.130/}{\textbf{Feather-SQL: A Lightweight NL2SQL Framework with Dual-Model Collaboration Paradigm for Small Language Models}}.\\
Published in IJCNLP-AACL 2025 Findings; earlier version presented at ICLR 2025 DL4C Workshop as \textit{Optimizing Small Language Models for NL2SQL} \hfill 2025
\item \textit{Wenqi Pei, Shizheng Hou, Boyan Li, \textbf{CHEN Han}, Zhichao Shi, Yuyu Luo.} \href{https://arxiv.org/pdf/2604.12988}{\textbf{ROSE: An Intent-Centered Evaluation Metric for NL2SQL}}. Accepted at ACL 2026 Main \hfill 2026
\item \textit{Jian Yang, Zhizhuo KOU, \textbf{CHEN Han}, Hao Zhang, Yao Tian, Sirui Han, Yike Guo.} \href{https://openreview.net/forum?id=Te2JbNghgm}{\textbf{RW-TTT: Batched Serving for Request-Owned Test-Time Training State}}. Accepted at EMNLP 2026 Main Conference \hfill 2026
\item \textit{Wenqi Pei, Henry Hengyuan Zhao, Yilai Liu, Jiahao Meng, \textbf{CHEN Han}, Ziyu Wang, Hongyang Du.} \href{https://openreview.net/forum?id=s4NT3igkq3}{\textbf{TempCloze: Can Video-LLMs Identify the Missing Middle?}} Accepted at EMNLP 2026 Findings \hfill 2026
\item \textit{Haowen Zheng, \textbf{CHEN Han}, Yingrong Coral Sung, Meng-Hsun Tsai.} \textbf{PI-Defender: A Lightweight Performance Interface Defense Mechanism Against Side-Channel Attacks}. Accepted at IEEE GLOBECOM 2026 \hfill 2026
\end{outerlist}
...
\item {\it\textbf{Ph.D. Research: Efficient Agent Memory System for LLM Agents}} in \textbf{National University of Singapore}\\
Supervisor: \href{https://www.comp.nus.edu.sg/~hebs/}{Prof. HE Bingsheng}\hfill Jan.--May 2026\\
\vspace{-0.2in}
\begin{innerlist}
        \item Design \textit{MemForest}, an agent memory system that reformulates LLM agent memory as a write-efficient temporal data problem, decoupling memory construction into parallelizable operations.
        \item Propose \textit{MemTree}, a hierarchical temporal index that organizes memory as time-ordered trees with localized per-node updates, replacing costly full-state rewrites.
        \item Achieve 89\% pass@8 accuracy on LongMemEval-S with approximately 6$\times$ higher memory construction throughput than state-of-the-art EverMemOS.
        \item Sponsored by \href{https://0g.ai/}{0G Labs (Zero Gravity Labs)}, a blockchain infrastructure company building the decentralized L1 for AI agents.
        \item Revision for VLDB 2027. \space \href{https://arxiv.org/abs/2605.23986}{[Paper]} \space \href{https://github.com/Concyclics/MemForest}{[Code]}
\end{innerlist}

\item {\it\textbf{Cryptography Engineer: Efficient Cipher Implementation and Whitebox Design}} in \textbf{SG Digital Trust Lab, Singapore Research Center, 2012 Laboratory}\\
Mentor: \href{mailto:Wu.Shuang@huawei.com}{Dr. WU Shuang}\hfill Jan.-June 2025\\
\vspace{-0.2in}
\begin{innerlist}
        \item Design whitebox implementation of AES for different platforms, products and scenarios.
        \item Implement HiAE cipher for kernel and user space, integrate it into several products, including mobile phone, server and auto-driving chips.
        \item Optimize the performance of SM2, SM3 and SM4 ciphers on ARM platforms.
\end{innerlist}
...
Mentor: \href{https://www.comp.nus.edu.sg/~hebs/}{Prof. HE Bingsheng}\hfill May-Sept.  2024\\
\vspace{-0.2in}
\begin{innerlist}
...
Mentor: \href{http://www2.scut.edu.cn/sse/2018/0614/c16789a270678/page.htm}{Prof. TANG Deyou}\hfill May-Dec. 2022\\
\vspace{-0.2in}
\begin{innerlist}
...
\vspace{-0.4in}
\\
\href{https://www.nus.edu.sg/}{\textbf{新加坡国立大学}}, 新加坡 \hfill 2025--现在
\begin{innerlist}
        \item 计算机科学博士. \hfill 导师: \href{https://www.comp.nus.edu.sg/~hebs/}{何丙胜教授}
\end{innerlist}
\href{https://www.nus.edu.sg/}{\textbf{新加坡国立大学}}, 新加坡 \hfill 2023--2025
\begin{innerlist}
        \item 计算机科学硕士. \hfill GPA: 4.4/5.0
\end{innerlist}
...
\vspace{-0.5in}
\begin{outerlist}
        \item \textit{\textbf{CHEN Han}, Zining Zhang, Wenqi Pei, Bingsheng He, Ming Wu, Jason Zeng, Michael Heinrich, Wei Wu, Hongbao Zhang.} \href{https://arxiv.org/abs/2605.23986}{\textbf{MemForest: An Efficient Agent Memory System with Hierarchical Temporal Indexing}}. VLDB 2027 Revision \hfill 2026
        \item \textit{\textbf{CHEN Han}, Tao Huang, Phuong Pham, Shuang Wu.} \href{https://eprint.iacr.org/2025/377}{\textbf{HiAE: A High-Throughput Authenticated Encryption Algorithm for Cross-Platform Efficiency}}. Cryptology ePrint Archive, Report 2025/377 \hfill 2025
        \item \textit{\textbf{CHEN Han}, Zicong Jiang, Zining Zhang, Bingsheng He, Pingyi Luo, Mian Lu, Yuqiang Chen.} \href{https://arxiv.org/abs/2503.19950}{\textbf{LogQuant: Log-Distributed 2-Bit Quantization of KV Cache with Superior Accuracy Preservation}}. 录用于 ICLR 2025 Sparsity in LLMs Workshop \hfill 2025
        \item \textit{Wenqi Pei, Hailing Xu, Henry Hengyuan Zhao, Shizheng Hou, \textbf{CHEN Han}, Zining Zhang, Pingyi Luo, Bingsheng He.} \href{https://aclanthology.org/2025.findings-ijcnlp.130/}{\textbf{Feather-SQL: A Lightweight NL2SQL Framework with Dual-Model Collaboration Paradigm for Small Language Models}}. 发表于 IJCNLP-AACL 2025 Findings；早期版本以 \textit{Optimizing Small Language Models for NL2SQL} 为题发表于 ICLR 2025 DL4C Workshop \hfill 2025
        \item \textit{Wenqi Pei, Shizheng Hou, Boyan Li, \textbf{CHEN Han}, Zhichao Shi, Yuyu Luo.} \href{https://arxiv.org/pdf/2604.12988}{\textbf{ROSE: An Intent-Centered Evaluation Metric for NL2SQL}}. 录用于 ACL 2026 Main \hfill 2026
        \item \textit{Jian Yang, Zhizhuo KOU, \textbf{CHEN Han}, Hao Zhang, Yao Tian, Sirui Han, Yike Guo.} \href{https://openreview.net/forum?id=Te2JbNghgm}{\textbf{RW-TTT: Batched Serving for Request-Owned Test-Time Training State}}. 录用于 EMNLP 2026 Main Conference \hfill 2026
        \item \textit{Wenqi Pei, Henry Hengyuan Zhao, Yilai Liu, Jiahao Meng, \textbf{CHEN Han}, Ziyu Wang, Hongyang Du.} \href{https://openreview.net/forum?id=s4NT3igkq3}{\textbf{TempCloze: Can Video-LLMs Identify the Missing Middle?}} 录用于 EMNLP 2026 Findings \hfill 2026
        \item \textit{Haowen Zheng, \textbf{CHEN Han}, Yingrong Coral Sung, Meng-Hsun Tsai.} \textbf{PI-Defender: A Lightweight Performance Interface Defense Mechanism Against Side-Channel Attacks}. 录用于 IEEE GLOBECOM 2026 \hfill 2026
\end{outerlist}
\noindent\rule{\textwidth}{1pt}
%% ================== block:  ==========================
\section{项目经历} % (fold)
...
\vspace{-0.5in}
\begin{outerlist}
\item {\it\textbf{博士研究: 面向大语言模型智能体的高效记忆系统}}: 新加坡国立大学 \hfill 2026/01--2026/05\\
        导师: \href{https://www.comp.nus.edu.sg/~hebs/}{何丙胜教授}
        \begin{innerlist}
                \item 设计了\textit{MemForest}智能体记忆系统, 将LLM智能体记忆重新建模为写入高效的时序数据问题, 将记忆构建解耦为可并行操作。
                \item 提出\textit{MemTree}层次化时序索引结构, 将记忆组织为时间有序的树, 用局部节点更新替代代价高昂的全状态重写。
                \item 在LongMemEval-S基准上达到89\% pass@8准确率, 同时记忆构建吞吐量约为最新方法EverMemOS的6倍。
                \item 该项目由\href{https://0g.ai/}{0G Labs (Zero Gravity Labs)}赞助, 一家为AI智能体构建去中心化L1区块链基础设施的公司。
                \item VLDB 2027 Revision. \href{https://arxiv.org/abs/2605.23986}{[Paper]} \href{https://github.com/Concyclics/MemForest}{[Code]}
        \end{innerlist}

\item {\it\textbf{密码算法工程师: 高效密码算法实现和白盒设计}}: 新加坡数字信任实验室, 华为2012实验室新加坡研究所 \hfill 2025/01--2025/06\\
        导师: \href{mailto:Wu.Shuang@huawei.com}{吴双博士}
        \begin{innerlist}
                \item 设计了不同场景和平台的AES白盒实现。
                \item 在用户态和内核态实现了HiAE密码算法, 并集成到多种产品中, 包括手机、服务器和自动驾驶芯片。
                \item 优化了SM2、SM3和SM4密码算法在ARM平台上的性能。
        \end{innerlist}
