...
\begin{outerlist}
	...
	\item \textbf{National Scholarship} \hfill 2022
        ...
        \item \textbf{Honorable Mention} Mathematical Contest in Modeling \hfill 2023
	
	\item \textbf{Outstanding Diploma Project of South China University of Technology} \hfill 2023
...
\vspace{-0.2in}
    ...
    \\
    \href{https://www.nus.edu.sg/}{\textbf{新加坡国立大学}}, 计算机硕士, 新加坡. \hfill 2023--now
...
\begin{outerlist}
  ...
  \item {\it 编程语言}: C/C++, Python, Fortran, MySQL, sqlite, \LaTeX.
  \item {\it 编程技能}：intel oneapi, blas, openmp, pthread, cuda. 
...
\item \textbf{二等奖} 美国大学生数学建模竞赛 (MCM/ICM) \hfill 2023
\item \textbf{华南理工大学本科优秀毕业设计(论文)} \hfill 2023
...
\item {\it 粤港澳大湾区极端天气气候灾害链的风险管控与应对} \hfill 2022/03-2022/07\\ 
 	...
 	导师: \href{http://www2.scut.edu.cn/sse/2019/0419/c16789a314444/page.htm}{陶乾}
        \begin{innerlist}
                工作内容: 利用图注意力神经网络进行气象预测和灾害预警，并进行可视化展示。
        \end{innerlist}
 	
 \item {\it 对称矩阵函数求解BBK算法的并行优化} \hfill 2022/04-2022/12\\
 	单位:  	华为鲲鹏计算\quad
 	导师: \href{http://www2.scut.edu.cn/sse/2018/0614/c16789a270678/page.htm}{汤德佑}
        \begin{innerlist}
                工作内容: \item 实现Bounded Bunch-Kaufman (BBK)算法，利用NEON指令集和OpenMP进行优化。
                \item 对求解的行交换操作进行并行和访存优化，实现总体接口70\%的性能提升。
        \end{innerlist}

 \item {\it\textbf{科研助理}} \hfill 2023/04--至今\\
        单位: \textbf{\href{https://hkust-gz.edu.cn/zh/?variant=zh-cn}{香港科技大学广州校区}}\quad
