...
% \makeheading{Curriculum Vitae\\ [0.3cm] TIEP HUU VU\quad~~~~~~\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad{\small Last update: December 17, 2015}}
\makeheading{CHEN Han \hfill {\small Last update: July 17th, 2026}}
...
\item \textit{Jian Yang, Zhizhuo Kou, Yao Tian, Hao Zhang, \textbf{CHEN Han}, Sirui Han, Yike Guo.} \href{https://arxiv.org/abs/2605.28053}{\textbf{RW-TTT: Batched Serving for Request-Owned Test-Time Training State}}. Submitted to EMNLP 2026 \hfill 2026
\end{outerlist}
...
\begin{outerlist}
        ...
        \item \textit{Jian Yang, Zhizhuo Kou, Yao Tian, Hao Zhang, \textbf{CHEN Han}, Sirui Han, Yike Guo.} \href{https://arxiv.org/abs/2605.28053}{\textbf{RW-TTT: Batched Serving for Request-Owned Test-Time Training State}}. 已投稿至 EMNLP 2026 \hfill 2026
\end{outerlist}
\noindent\rule{\textwidth}{1pt}
%% ================== block:  ==========================
\section{项目经历} % (fold)
