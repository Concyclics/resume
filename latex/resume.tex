...
% \makeheading{Curriculum Vitae\\ [0.3cm] TIEP HUU VU\quad~~~~~~\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad{\small Last update: December 17, 2015}}
\makeheading{CHEN Han \hfill {\small Last update: Oct. 22, 2024}}
...
\vspace{-0.2in}
\begin{innerlist}
        \item Develop a structure for high performance SIMD based encryption by the Cryptographic SIMD implementation difference between ARM and x86 architecture.
        \item Design a new AEAD stream cipher to achieve 4x speedup than AES-GCM encryption algorithm on popular mobile processors.
        \item On submission to FSE(Fast Software Encryption) 2025.
\end{innerlist}
...
\item {\it\textbf{实习生: 密码算法工程师}}: 华为2012实验室新加坡研究所数字信任实验室 \hfill 2024/01--2024/05\\
        导师：黄涛博士
        \begin{innerlist}
                \item 通过ARM和x86架构的密码学SIMD实现差异, 设计了一个高性能的SIMD加密结构。
                \item 设计了一种新的AEAD流密码, 在主流的移动处理器上, 比AES-GCM加密算法实现了4倍的加速。
                \item 该项目计划投稿至FSE(Fast Software Encryption) 2025。
        \end{innerlist}
